@echo off
chcp 65001 >nul 2>&1
REM Shopmind AI Service Quick Start Script (Windows)

echo ================================
echo   Shopmind AI Service Startup
echo ================================
echo.
...
uv run python -m uvicorn app.main:app --reload --host 0.0.0.0 --port 8085 --http h11
