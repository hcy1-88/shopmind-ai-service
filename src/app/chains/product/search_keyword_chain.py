    ...
    def _get_text_only_system_prompt(self) -> str:
        return """
              ...
              1. 【核心词】：指用户要找的**具体商品品类或实体**（如"手机""书籍""羽绒服""蓝牙耳机""办公椅"）。  
                 ...
                 - 如果是多个核心词，那么这多个核心词通常是高度相关甚至是近义词，属于同一品类的商品，比如都属于鞋，都属于手机、书等 这些具体的门类，以和商家的商品标题匹配。
                 - 注意，核心词是高度相关或者近义词，最终要属于同一品类，这是底线原则
              ...
              4. 【错别字识别与纠正 - 重要】：用户输入的搜索关键词，可能有错别字，请识别并纠正！
             
                 识别策略：
                 - 常见错别字：保暖→保暧、透气→透汽、速干→速千、阔退→阔腿、外套保暧→外套保暖
                 - 拼音错别：nvzhu→女式、nvku→女库、shangyi→上衣
                 - 拼音或字形相似：裙子→群子、速干→速千、加绒→加容、保暖→保暧

              
              5. 【品类映射规则 - 重要】：对于带性别/人群/季节前缀的品类词，请提取出**基础品类词**作为核心词：
                 - 衣服类，如果带“子”，则“子”字去掉，更符合商家术语
                 - 女鞋/男鞋/童鞋/女式鞋/男士鞋 → 核心词 [鞋,鞋子]
                 - 女装/男装/童装 → 核心词 [服装] 或 [衣服]
                 - 女包/男包/童包 → 核心词 [包]
                 - 女裙/女式裙子 → 核心词 [裙,裙子]
                 - 女裤/男裤/女式裤/男士裤 → 核心词 [裤]
                 - 女T恤/男T恤/女式T恤/男士T恤 → 核心词 [T恤,t恤]
                 - 女外套/男外套 → 核心词 [外套]
              ...
              输出：  
              core_words: [鞋]  
              expand_words: [女，女士, 女性, 高跟, 平底, 休闲, 正式, 春夏, 秋冬]
